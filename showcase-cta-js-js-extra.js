var showcaseCTA = {
  adminUrl: "https://websitedemos.net/communities-02/wp-admin/",
  networkSiteURL: "https://websitedemos.net/",
  templateName: "Charity",
  isMainSite: "",
  ...
  customizerData: {
    "astra-settings": {
      ...
      "button-h-color": "var(--ast-global-color-0)",
      ...
      "theme-button-padding": {
        desktop: { top: "17", right: "35", bottom: "17", left: "35" },
        tablet: { top: "", right: "", bottom: "", left: "" },
        mobile: { top: "", right: "", bottom: "", left: "" },
        "desktop-unit": "px",
        "tablet-unit": "px",
      ...
      "ast-header-retina-logo":
        "https://websitedemos.net/communities-02/wp-content/uploads/sites/853/2021/05/logo-retina-free-img.png",
      ...
      "secondary-font-weight-button": "600",
      ...
      "hb-header-main-sep-color":
        "var( --ast-global-color-subtle-background, --ast-global-color-7 )",
      "hb-header-main-menu-align": "inline",
      "hb-header-bg-obj-responsive": {
        desktop: {
          "background-color":
            "var( --ast-global-color-primary, --ast-global-color-4 )",
          "background-image": "",
          "background-repeat": "repeat",
          "background-position": "center center",
          "background-size": "auto",
      ...
      "hba-header-bottom-border-color":
        "var( --ast-global-color-subtle-background, --ast-global-color-7 )",
      ...
      "hbb-header-bottom-border-color":
        "var( --ast-global-color-subtle-background, --ast-global-color-7 )",
      ...
      "header-mobile-menu-menu-spacing": {
        desktop: { top: "", right: "", bottom: "", left: "" },
        tablet: { top: "10", right: "30", bottom: "10", left: "30" },
        mobile: { top: "", right: "", bottom: "", left: "" },
        "desktop-unit": "px",
        "tablet-unit": "px",
        "mobile-unit": "px",
      ...
      "section-above-footer-builder-padding": {
        desktop: { top: "", right: "", bottom: "", left: "" },
        tablet: { top: "40", right: "80", bottom: "40", left: "80" },
        mobile: { top: "80", right: "25", bottom: "60", left: "25" },
        "desktop-unit": "px",
        "tablet-unit": "px",
        "mobile-unit": "px",
      },
      "section-above-footer-builder-margin": {
        desktop: { top: "", right: "", bottom: "", left: "" },
        tablet: { top: "", right: "0", bottom: "", left: "0" },
        mobile: { top: "", right: "", bottom: "", left: "" },
        "desktop-unit": "px",
        "tablet-unit": "px",
        "mobile-unit": "px",
      ...
      "section-primary-footer-builder-padding": {
        ...
        tablet: { top: "60", right: "30", bottom: "60", left: "30" },
        mobile: { top: "50", right: "25", bottom: "50", left: "25" },
        "desktop-unit": "px",
        "tablet-unit": "px",
        "mobile-unit": "px",
      },
      ...
      "footer-html-1":
        '<h6><span style="color: #fff;">GIVE US A HAND</span></h6>',
      "footer-html-1color": {
      ...
      "footer-social-1-color": { desktop: "rgba(255,255,255,0.5)" },
      "footer-social-1-h-color": { desktop: "#ffffff" },
      ...
      "section-fb-social-icons-1-margin": {
        desktop: { top: "5", right: "", bottom: "", left: "" },
        tablet: { top: "", right: "", bottom: "", left: "" },
        mobile: { top: "", right: "", bottom: "", left: "" },
        "desktop-unit": "px",
        "tablet-unit": "px",
      ...
      "sidebar-widgets-footer-widget-1-margin": {
        desktop: { top: "", right: "", bottom: "", left: "" },
        tablet: { top: "", right: "", bottom: "", left: "" },
        mobile: { top: "", right: "", bottom: "50", left: "" },
        "desktop-unit": "px",
        "tablet-unit": "px",
        "mobile-unit": "px",
      },
      ...
      "footer-html-2":
        '<h2><span style="color: #ffffff;">Support us and change the course of a child\u2019s life today!</span></h2>',
      "footer-html-2color": { desktop: "#ffffff", tablet: "", mobile: "" },
      ...
      "section-fb-html-2-margin": {
        desktop: { top: "20", right: "", bottom: "55", left: "" },
        tablet: { top: "", right: "", bottom: "", left: "" },
        mobile: { top: "", right: "", bottom: "", left: "" },
        "desktop-unit": "px",
        "tablet-unit": "px",
      ...
      "footer-widget-2-color": { desktop: "#ffffff", tablet: "", mobile: "" },
      ...
      "footer-desktop-items": {
        above: {
          above_1: ["html-1", "html-2", "widget-4"],
          above_2: [],
          above_3: [],
          above_4: [],
          above_5: [],
        ...
        primary: {
          primary_1: ["widget-1"],
          primary_2: [],
          primary_3: ["widget-2", "social-icons-1"],
          primary_4: [],
          primary_5: [],
          primary_6: [],
        },
        ...
        layouts: {
          above: {
            column: "1",
            layout: { mobile: "full", tablet: "full", desktop: "full" },
          },
          primary: {
            column: "3",
            layout: {
      ...
      "hbb-footer-top-border-color": "rgba(255,255,255,0.15)",
      ...
      "hb-footer-main-sep-color":
        "var( --ast-global-color-subtle-background, --ast-global-color-7 )",
      "live-search-result-count": 5,
      ...
      "section-below-footer-builder-padding": {
        desktop: { top: "", right: "", bottom: "", left: "" },
        tablet: { top: "", right: "", bottom: "", left: "" },
        mobile: { top: "", right: "25", bottom: "", left: "25" },
        "desktop-unit": "px",
        "tablet-unit": "px",
        "mobile-unit": "px",
      },
      ...
      "woo-header-cart-product-count-color-group":
        "var( --ast-global-color-secondary, --ast-global-color-5 )",
      ...
      "header-account-icon-color": "var(--ast-global-color-2)",
      "header-account-login-link": { url: "", new_tab: false, link_rel: "" },
      "header-account-logout-link": {
        url: "https://websitedemos.net/communities-02/wp-login.php",
        new_tab: false,
        link_rel: "",
      },
      ...
      "theme-btn-letter-spacing": 2,
      "hb-inner-spacing": { desktop: 30 },
      ...
      "astra-sidebar-widgets-footer-widget-4-margin": {
        desktop: { top: "", right: "", bottom: "-30", left: "" },
        tablet: { top: "", right: "", bottom: "-30", left: "" },
        mobile: { top: "", right: "", bottom: "-30", left: "" },
        "desktop-unit": "px",
        "tablet-unit": "px",
        "mobile-unit": "px",
      },
      ...
      "enable-4-8-9-compatibility": false,
      "star-rating-comp": false,
      "v4-9-0-backward-option": false,
    },
    "custom-css": "",
  },
  siteType: "free",
